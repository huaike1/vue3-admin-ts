    ...
    NEW_ACTION = function () {
      !(function (e) {
        ...
        function (e, n, t) {
          "use strict";
          function i(e, n) {
            if (b) return void e.classList.add(n);
            var t = e.className || "";
            t.match(new RegExp("(^|\\s)" + n + "(\\s|$)")) ||
              (e.className = t + " " + n);
          }
          function o(e, n) {
            if (b) return void e.classList.remove(n);
            var t = e.className || "",
              i = t
          ...
          function a(e, n, t) {
            ...
            (i.onload = function () {
              (i.onload = null),
                ...
                o != -1 && (clearTimeout(o), n("ok"));
            }),
              (i.onerror = function () {
                (i.onerror = null),
                  i.parentNode.removeChild(i),
                  o != -1 && (clearTimeout(o), n("err"));
              }),
          ...
          function c(e, n, t, i) {
            function o() {
              ...
              l > 1 && (u = e + s + "__retry=" + l),
                a(
                  u,
                  function (e) {
                    if (r) return void n(y);
                    if ("ok" === e) n(e);
                    else {
                      if (e === y || l >= i) return void n(y);
            ...
            (n = (function (e) {
              return function () {
                s || ((s = !0), clearTimeout(c), e.apply(null, arguments));
              };
            })(n)),
              o(),
              setTimeout(function () {
          ...
          function s(e, n, t, i) {
            ...
            (e = e + s + r(n)),
              a(
                e,
                function (e) {
                  o !== -1 && "ok" != e && (clearTimeout(o), t(e));
                },
                i
              ),
              (v[c] = function (e) {
                delete v[c], clearTimeout(o), t("ok", e);
              }),
              (o = setTimeout(function () {
                (o = -1), t(y);
              }, i));
          ...
          function l(e, n, t, i, o) {
            function r() {
              ...
              u > 1 && (f = e + l + "__retry=" + u),
                s(
                  ...
                  n,
                  function (e, n) {
                    if (a) return void t(y);
                    if ("ok" === e) t(e, n);
                    else {
                      if (e === y || u >= o) return void t(y);
                      c = setTimeout(function () {
                        r();
                      }, 3e3);
                    }
            ...
            (t = (function (e) {
              return function () {
                l || ((l = !0), clearTimeout(c), e.apply(null, arguments));
              };
            })(t)),
              r(),
              setTimeout(function () {
          ...
          function u(e) {
            for (
              var n, t, i = [].slice.call(arguments), o = i.length, r = 1;
              r < o;
              r++
            ) {
              n = i[r];
          ...
          function f(e) {
            ...
            if ("object" === ("undefined" == typeof e ? "undefined" : h(e))) {
              ...
              if (e.sort) {
                for (n = 0; n < e.length; n++) t.push(i(e[n]));
                t = "[" + t.join() + "]";
              } else {
                for (n in e)
          ...
          function d(e, n) {
            n &&
              p(e, n) &&
              (e.classList
                ? e.classList.remove.apply(e.classList, n.split(/\s+/))
          ...
          function p(e, n) {
            ...
            if (e.classList) {
              for (var t = n.split(/\s+/), i = 0; i < t.length; i++)
                if (!e.classList.contains(t[i])) return !1;
              return !0;
            }
            return new RegExp("(\\s|^)" + n + "(\\s|$)").test(e.className);
          }
          function _(e, n, t) {
            if (((n = n || m), (t = t || "*"), m.getElementsByClassName))
              return n.getElementsByClassName(e);
            for (
              var i = [],
                o = "*" === t && n.all ? n.all : n.getElementsByTagName(t),
                r = o.length;
              --r >= 0;
        ...
        function (e, n, t) {
          ...
          function i(e) {
            return this instanceof i
              ? ((this._state = l),
                ...
                (this._value = null),
                (this._reason = null),
                void (d(e) && e(a(this.resolve, this), a(this.reject, this))))
              : new i(e);
          }
          function o(e, n, t) {
            return function (i) {
          ...
          function a(e, n) {
            var t = [].slice,
              ...
              r = function () {
                return e.apply(
                  this instanceof o ? this : n,
                  i.concat(t.call(arguments))
                );
              };
            return (o.prototype = e.prototype), (r.prototype = new o()), r;
          }
          function c(e) {
            return function (n) {
          ...
          function s(e, n) {
            for (var t = 0, i = e.length; t < i; t++) n(e[t], t);
          }
          var l = 0,
            u = 1,
            f = 2;
        ...
        function (e, n, t) {
          ...
          function i(e, n, t) {
            if (e) {
              var i = 0,
                o = e.length;
              if (o === +o) for (; i < o && n.call(t, e[i], i, e) !== !1; i++);
              else
                for (i in e)
          ...
          function r(e, n) {
            n &&
              !o(e, n) &&
              (e.classList
                ? e.classList.add.apply(e.classList, n.split(/\s+/))
                : (e.className += " " + n));
          }
          function a(e, n) {
            n &&
          ...
          (n.each = i),
            ...
            (n.getElementsByClassName = function (e, n, t) {
              if (((n = n || d), (t = t || "*"), d.getElementsByClassName))
                return n.getElementsByClassName(e);
              for (
                var i = [],
                  r = "*" === t && n.all ? n.all : n.getElementsByTagName(t),
                  a = r.length;
                --a >= 0;
          ...
          (n.getClientRect = function (e) {
            ...
            if ((d.documentElement.scrollLeft, e.getBoundingClientRect)) {
            ...
            v = {
              ...
              after: function (e, n) {
                return function () {
                  ...
                  return n.call(this, t, arguments), t;
                };
              },
            };
          (n.decorator = v),
            ...
            (n.imageLoaded = function (e) {
              ...
              return (
                ...
                (t.onerror = function (e) {
                  n.reject({ type: "img", error: e });
                }),
                setTimeout(function () {
                  n.reject({ type: "img", error: "timeout" });
                }, 5e3),
                (t.src = e),
                n.promise
              );
            ...
            (n.request = function (e) {
              ...
              return (
                ...
                setTimeout(function () {
                  n.reject({ type: "request", error: "timeout" });
                }, 5e3),
                n.promise
              );
            }),
        ...
        function (e, n) {
          function t(e, n) {
            for (var t = 0; t < e.length; t++) {
              ...
              if (o) {
                ...
                for (; r < i.parts.length; r++) o.parts.push(s(i.parts[r], n));
              } else {
          ...
          var d = {},
            p = function (e) {
              ...
              return function () {
                return (
                  "undefined" == typeof n && (n = e.apply(this, arguments)), n
                );
              };
            },
            _ = p(function () {
        ...
        function (e, n, t) {
          ...
          function i(e, n) {
            var t;
            for (t in n) n.hasOwnProperty(t) && ((r[t] = r[t] || {})[e] = n[t]);
          }
          function o(e, n) {
            var t = { zh_CN: "cn", zh_TW: "tw", en_US: "en" };
            return e in t && (e = t[e]), r[n][e || "cn"];
          }
          var r = {
            SLIDER_LABEL: {
              cn: "\u5411\u53f3\u6ed1\u52a8\u9a8c\u8bc1",
            ...
            OVERLAY_INFORM: {
              ...
              ar_SA:
                "\u062a\u0645 \u0627\u0644\u0643\u0634\u0641 \u0639\u0646 \u0645\u062e\u0627\u0637\u0631 \u0641\u064a \u0628\u064a\u0626\u0629 \u0627\u0644\u062a\u0634\u063a\u064a\u0644 \u0627\u0644\u062d\u0627\u0644\u064a\u0629 \u0627\u0644\u062e\u0627\u0635\u0629 \u0628\u0643 \u060c \u064a\u0631\u062c\u0649 \u0625\u062f\u062e\u0627\u0644 \u0631\u0645\u0632 \u0627\u0644\u062a\u062d\u0642\u0642",
              de_DE:
                "In Ihrer aktuellen Betriebsumgebung wurde ein Risiko festgestellt. Geben Sie den Best\xe4tigungscode ein",
              es_ES:
                "Se ha detectado un riesgo con su entorno operativo actual, ingrese el c\xf3digo de verificaci\xf3n",
              fr_FR:
                "Un risque a \xe9t\xe9 d\xe9tect\xe9 avec votre environnement d'exploitation actuel, veuillez saisir le code de v\xe9rification",
              it_IT:
                "\xc8 stato rilevato un rischio con il tuo attuale ambiente operativo, inserisci il codice di verifica",
              ja_JP:
                "\u73fe\u5728\u306e\u74b0\u5883\u3067\u30ea\u30b9\u30af\u304c\u691c\u51fa\u3055\u308c\u307e\u3057\u305f\u3001\u78ba\u8a8d\u30b3\u30fc\u30c9\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044",
              ko_KR:
                "\ud604\uc7ac \uc6b4\uc601 \ud658\uacbd\uc5d0\uc11c \uc704\ud5d8\uc774 \uac10\uc9c0\ub418\uc5c8\uc2b5\ub2c8\ub2e4. \ud655\uc778 \ucf54\ub4dc\ub97c \uc785\ub825\ud558\uc138\uc694.",
              ru_RU:
                "\u0412 \u0432\u0430\u0448\u0435\u0439 \u0442\u0435\u043a\u0443\u0449\u0435\u0439 \u043e\u043f\u0435\u0440\u0430\u0446\u0438\u043e\u043d\u043d\u043e\u0439 \u0441\u0440\u0435\u0434\u0435 \u043e\u0431\u043d\u0430\u0440\u0443\u0436\u0435\u043d \u0440\u0438\u0441\u043a, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u043f\u0440\u043e\u0432\u0435\u0440\u043e\u0447\u043d\u044b\u0439 \u043a\u043e\u0434",
              th_TH:
                "\u0e15\u0e23\u0e27\u0e08\u0e1e\u0e1a\u0e04\u0e27\u0e32\u0e21\u0e40\u0e2a\u0e35\u0e48\u0e22\u0e07\u0e43\u0e19\u0e2a\u0e20\u0e32\u0e1e\u0e41\u0e27\u0e14\u0e25\u0e49\u0e2d\u0e21\u0e01\u0e32\u0e23\u0e17\u0e33\u0e07\u0e32\u0e19\u0e1b\u0e31\u0e08\u0e08\u0e38\u0e1a\u0e31\u0e19\u0e02\u0e2d\u0e07\u0e04\u0e38\u0e13\u0e42\u0e1b\u0e23\u0e14\u0e1b\u0e49\u0e2d\u0e19\u0e23\u0e2b\u0e31\u0e2a\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19",
            },
            FEEDBACK_URL: {
            ...
            CLICK_LABEL_READY: {
              ...
              ko_KR:
                "\ud655\uc778\ud558\ub824\uba74 \uc6d0\uc744 \ud074\ub9ad\ud558\uc138\uc694.",
              ru_RU:
                "\u0429\u0435\u043b\u043a\u043d\u0438\u0442\u0435 \u043a\u0440\u0443\u0433, \u0447\u0442\u043e\u0431\u044b \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c",
              th_TH:
                "\u0e04\u0e25\u0e34\u0e01\u0e27\u0e07\u0e01\u0e25\u0e21\u0e40\u0e1e\u0e37\u0e48\u0e2d\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19",
            },
          };
          (n.i18n = r), (n.upLang = i), (n.trans = o);
        },
        function (e, n, t) {
          "use strict";
          var i = window,
          ...
          !(function () {
            var t = {
              ...
              beforeEvent: function (e, n, i, o, r) {
                if (
                  !1 === t.beforeThisEvent(e, n, i, o, r) ||
                  !1 === t.beforeAnyEvent(e, n, i, o, r)
                )
                  return !1;
              },
              afterEvent: function (e, n, i, o, r) {
                t.afterThisEvent(e, n, i, o, r), t.afterAnyEvent(e, n, i, o, r);
              },
              leaveState: function (e, n, i, o, r) {
                ...
                return (
                  !1 !== a &&
                  !1 !== c &&
                  (t.ASYNC === a || t.ASYNC === c ? t.ASYNC : void 0)
                );
              },
              enterState: function (e, n, i, o, r) {
                t.enterThisState(e, n, i, o, r), t.enterAnyState(e, n, i, o, r);
              },
              buildEvent: function (e, n) {
                return function () {
                  var i = this.current,
                    o =
                      n[i] ||
                      (n[t.WILDCARD] != t.WILDCARD ? n[t.WILDCARD] : i) ||
                      i,
                  ...
                  if (i === o)
                    return (
                      t.afterEvent(this, e, i, o, r), t.Result.NOTRANSITION
                    );
                  var a = this;
                  (this.transition = function () {
                    ...
                    (this.transition.cancel = function () {
                      (a.transition = null), t.afterEvent(a, e, i, o, r);
                    });
        ...
        function (e, n, t) {
          ...
          var s,
            ...
            p = {
              ...
              fr_FR: {
                _ggk_guide:
                  "Faites glisser sur l'\xe9cran pour gratter deux poulets",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              de_DE: {
                _ggk_guide:
                  "Wischen Sie auf dem Bildschim, um zwei H\xfchner zu kratzen",
                _ggk_start: "",
                _ggk_net_err: [
              ...
              nl_NL: {
                _ggk_guide:
                  "Sleep over het scherm om twee kippen weg te strepen",
                _ggk_start: "",
                _ggk_net_err: [
        ...
        function (e, n, t) {
          ...
          function r(e) {
            ...
            t &&
              n &&
              a &&
              (n.parentNode.insertBefore(t, n), (a.style.display = "none")),
              (s = !1);
          }
          var a,
            c,
        ...
        function (e, n, t) {
          ...
          function i(e) {
            ...
            try {
              p.localStorage && !t && ((n = localStorage[e] || ""), (t = n));
            } catch (o) {}
          ...
          function r() {
            ...
            return (e = e || i(g)), e || ((e = h + a(11)), o(g, e, 3650)), e;
          }
          function a(e) {
          ...
          function c() {
            ...
            if ((u = e.token)) return u;
            var n = r();
            return (u = n + h + a(3)), (e.token = u), u;
          }
          function s() {
            if (f) return f;
            var e = "_umdata";
          ...
          var u,
            ...
            g = "_uab_collina",
            h =
              p.pointman && pointman._now
                ? pointman._now
                : new Date().getTime();
          (n.getSecToken = c), (n.getNCToken = l);
        },
        ,
        ,
        ,
        ...
        function (e, n, t) {
          ...
          function i(e) {
            !e.__nc_jsReady &&
              window.__captchah5__uab &&
              window.__captchah5__um &&
              ((e.__nc_jsReady = !0), e(!1));
          }
          function o(e, n) {
            l.init(e),
              a.__captchah5__uab
          ...
          function r(e, n) {
            ...
            (t = c.mix(t, e.apimap)),
              ...
              e.appkey &&
                0 === e.appkey.indexOf("X82Y") &&
                (window._umopt_npfp = 0),
              (window._umopt_cris = 0),
              a.__captchah5__um
                ? i(n)
                : AWSC.use("um", function (o, r) {
                    if ("loaded" === o) {
                      (a.__captchah5__um = r), i(n);
                      var c = location.href || "";
                      c = c.length < 128 ? c : c.substring(0, 128);
                      var s = 0,
                        l = function u() {
                          s++,
                            (a.__captchah5__umidToken =
        ...
        function (e, n, t) {
          ...
          (n.init = function (e, n) {
            ...
            (e.onenterts_verifying = function () {
              var r = t(".input"),
                a = r.value;
              if (((r.disabled = !0), !a)) return void e.ts_verifyfail();
              var c = n.net,
                s = t(".btn-ok");
              s.disabled = !0;
              var l = n.options;
                  ...
                  .then(function () {
                    return new s(function (n, i) {
                      o.render(t, function (t) {
                        return t ? void i(t) : (e.fire(c.ready), void n());
                      });
                    });
                  })
                  .then(function () {
        ...
        function (e, n, t) {
          ...
          n.init = function (e) {
            ...
            (n.onenterpass = function () {
              ...
              var n = (e.index > 0 ? e.index : 1, e.scrape.prefix),
                o = document.getElementById(n + "container");
              if (o && t.bg_back_pass) {
                var r = i.getElementsByClassName("nc-bg", o)[0];
        ...
        function (e, n, t) {
          ...
          n.init = function (e) {
            (window.__captchah5_uaboption = new Object()),
              e.is_Opt
                ? ((UA_Opt.MPInterval =
                    "undefined" != typeof UA_Opt.MPInterval &&
                    UA_Opt.MPInterval > 0
                      ? UA_Opt.MPInterval
                      : 4),
                  (UA_Opt.MaxMCLog =
                  ...
                  (UA_Opt.MaxMPLog =
                    "undefined" != typeof UA_Opt.MaxMPLog && UA_Opt.MaxMPLog > 0
                      ...
                      : 5),
                  (UA_Opt.MaxFocusLog =
                    "undefined" != typeof UA_Opt.MaxFocusLog &&
                  ...
                  (UA_Opt.SendInterval =
                    ...
                    UA_Opt.SendInterval > 0
                      ...
                      : 5),
                  (UA_Opt.SendMethod =
                    "undefined" != typeof UA_Opt.SendMethod &&
                    UA_Opt.SendMethod > 0
                      ? UA_Opt.SendMethod
                      : 8),
                  (UA_Opt.GPInterval =
                    "undefined" != typeof UA_Opt.GPInterval &&
                    UA_Opt.GPInterval > 0
                      ? UA_Opt.GPInterval
                      : 1),
                  (UA_Opt.MaxGPLog =
                  ...
                  (UA_Opt.Flag =
                    "undefined" != typeof UA_Opt.Flag && UA_Opt.Flag > 0
                      ...
                      : 2980046),
                  (UA_Opt.OnlyHost =
                    "undefined" != typeof UA_Opt.OnlyHost
                      ? UA_Opt.OnlyHost
                      : 1),
                  ...
                  (window.__captchah5_uaboption.MaxMTLog =
                    "undefined" != typeof UA_Opt.MaxMTLog
                      ? UA_Opt.MaxMTLog
                      : 300),
                  (window.__captchah5_uaboption.MinMTDwnLog =
                    "undefined" != typeof UA_Opt.MinMTDwnLog
                      ? UA_Opt.MinMTDwnLog
                      : 30),
                  (window.__captchah5_uaboption.MaxNGPLog =
                    "undefined" != typeof UA_Opt.MaxNGPLog
                      ? UA_Opt.MaxNGPLog
                      : 200),
        ...
        function (e, n, t) {
          ...
          n.makeNC = function () {
            ...
            (e.prototype = {
              init: function (e) {
                return this.__initialized
                  ...
                  : (this.nc_obj.init(e), void (this.__initialized = 1));
              },
            }),
              t(75);
            var n = t(11);
            return (
              ...
              (e.init = function (n) {
                var t;
                if (n.upLang) for (var a in n.upLang) e.upLang(a, n.upLang[a]);
                return (
                  i(n)
                    ? (t = new r.NC2(n, c))
                    : ((t = new o.NoCaptcha()), t.init(n)),
                  (e.__nc = t),
                  t
                );
              }),
        ...
        function (e, n, t) {
          ...
          !(function (e, n) {
            ...
            if (
              (e.getElementsByTagName("head")[0].appendChild(t), t.styleSheet)
            )
          ...
          (i.prototype = {
            init: function (e) {
              (e.token = e.token || u.getNCToken()),
                ...
                (e.apimap = e.apimap || {}),
                ("number" != typeof e.retryTimes || isNaN(e.retryTimes)) &&
                  (e.retryTimes = 5),
                (this.options = e);
              var n;
              try {
                n =
                  r.querySelector(e.renderTo) ||
                  r.querySelector("#" + e.renderTo);
              } catch (i) {
                n = void 0;
              }
              if ((f.getNCPunish(e, "init monitor"), o.MutationObserver && n)) {
                var a = function (t, i) {
                    var o =
                      n && n.innerHTML
                        ? n.innerHTML.replace(/[ \r\n\"<\/div>]/g, "")
                        : "null";
                    f.getNCPunish(e, o), c.disconnect();
                  },
            ...
            on: function (e, n) {
              l.names.hasOwnProperty(e) &&
                (this.event_listeners[e] = this.event_listeners[e] || []).push(
                  n
                );
            },
            fire: function (e) {
              var n,
                t,
                i = this.event_listeners[e];
              if (i)
                for (n = 0, t = i.length; n < t && i[n].call() !== !1; n++);
            },
            setEnabled: function (e) {
              e ? this.slider.enable() : this.slider.disable();
            },
            setTrans: function (e) {
              return e && (this.options.trans = e), this.options.trans;
            },
            getTrans: function () {
            ...
            _reset: function () {
              this.container && (this.container.style.display = "block"),
                this.options.appkey &&
                  ...
                  a.init(this.options),
                  (UA_Opt.Token =
                    new Date().getTime() + ":" + this.options.token),
                  UA_Opt.reload && UA_Opt.reload());
            },
            reset: function () {
              return this.fsm.can("reset")
                ? (this.fsm.reset(), !0)
                : (o.console && void 0, !1);
            },
            show: function () {
            ...
            f = (function () {
              function e(n, t) {
                ...
                n.foreign && (o = "en"),
                  ...
                  this.el ||
                    a.fail(
                      "'renderTo'(" + n.renderTo + ") does not match any node."
                    ),
                  this.makeFSM(),
                  this.initStates(),
                  (this.event_listeners = {}),
        ...
        function (e, n, t) {
          ...
          n.makeClickSlider = function (e) {
                ...
                e.on("ready", function () {
                  t("nc-iconfont icon-notclick"),
                    (p.innerHTML =
                      ...
                      o.trans(e.options.language, "CLICK_LABEL_READY"));
                }),
            ...
            function u() {
              ...
              for (var n in e) if (void 0 !== v.style[n]) return { end: e[n] };
              return !1;
            }
            function f() {
              g.removeEventListener(b, f), e.fire("actionend"), w && w();
            }
            function d() {
          ...
          var obj_w = -1,
            ...
            Scrape = (function () {
              function Scrape(e) {
                ...
                var t = {};
                if (
                  (n.foreign && (t.language = t.language || "en"),
                  ...
                  (this._last_y = -1),
                  (this.stroke_size =
                    n.stroke_size || cfg.default_stroke_width),
                  (this.svr_data = {}),
                  (this._t_action = null),
              ...
              return (
                _createClass(Scrape, [
                      ...
                      return Promise.all(
                        ...
                        .then(function (n) {
                          var t = 0,
                            i = 0;
                          util.map(n, function (e) {
                            (t = Math.max(t, e[0])), (i = Math.max(i, e[1]));
                          }),
                            (e.obj_w = t),
                            (e.obj_h = i);
                        })
                        ...
                        util.jsonp(
                          ...
                          function (i, o) {
                            ...
                            if (c && e.options.bg_back_prepared) {
                              var s = util.getElementsByClassName(
                                "nc-bg",
                                c
                              )[0];
                              s &&
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var n =
                        ...
                        o = getElementById(
                          0 === i.indexOf("#") ? i.slice(1) : i
                        ),
                        r = 0,
                        a = 0;
                      "absolute" == o.style.position &&
                        ((r = o.offsetLeft), (a = o.offsetTop));
                      var c =
                          (e.clientX + n || e.pageX) - (r + this.offsetX || 0),
                        s =
                          (e.clientY + t || e.pageY) - (a + this.offsetY || 0);
                      return [c, s];
                    },
                  },
                  {
                  ...
                  },
                  {
                    key: "_clearTo",
                    value: function (e, n) {
                      if (this.is_downgraded) return this._clearTo_dg(e, n);
                      var t = this.ctx;
                      (t.fillStyle = "#fff"),
                        t.beginPath(),
                  ...
                  },
                  {
                    ...
                    value: function (e, n, t, i) {
                      for (
                        var o = this.ctx.getImageData(e, n, t, i).data,
                          r = 0,
                          a = 0;
                        a < o.length;
                        a += 4
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      var o = this.is_downgraded ? 0.7 : 0.9,
                        ...
                        a = (this.obj_h / 2) * o;
                      return (
                        (t = util.map(this._points, function (n) {
                          var t = n.x,
                            i = n.y;
                  ...
                  },
                  {
                    ...
                    value: function (e, n) {
                      ...
                      if (
                        (e > 0.9 || t) &&
                        window.__captchah5__uab.isReadyForSC(
                          window.__captchah5_uaboption.mIDs
                        ) &&
                        ...
                        var o = [
                          win._n_bak,
                          util.obj2str(this._prepare_result),
                        ];
                        (this.nc._err = "3A"),
                            ...
                            util.jsonp(
                              ...
                              function (e, n) {
                                ...
                                if (n.success && n.result && n.result.success) {
                                  ...
                                  if (0 === i.code)
                                    return _this10.verify_ok(i), void resolve();
                      ...
                      return new Promise(function (e, t) {
                        ...
                        var i = function o() {
                          var t = n.getEl("load-error"),
                            i = void 0,
                            r = n.getEl("cover");
                          if (!n.size || !r) return void setTimeout(o, 10);
                          n.showEl("load-error"),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (
                        ((n.src = e.src = this.options.obj_fail), this.nc._err)
                      ) {
                      ...
                      return new Promise(function (n, t) {
                        try {
                          ...
                          if (
                            ...
                            return (
                              e.downgrade(), e.render_surface_dg(), void n()
                            );
                          e.render_surface(), n();
                        } catch (o) {
                          t(o);
        ...
        function (e, n, t) {
          ...
          n.makeNet = function (e, n) {
            ...
            function s() {
              ...
              try {
                navigator.connection
                  ? ((n.cntp = encodeURIComponent(navigator.connection.type)),
                    (n.cneftp = encodeURIComponent(
                ...
                if (navigator.getBattery) {
                  var o = Promise.race([
                    navigator.getBattery().then(function (e) {
                      e
                        ? ((n.btryc = e.charging), (n.btryl = e.level))
                        : (n.btry = "ns");
                    }),
            ...
            function d(e) {
              return parseInt(
                e.offsetWidth + "a" + e.offsetHeight + "a" + u(e) + "a" + f(e),
                11
              ).toString(16);
            }
            function p(e) {
              function r() {
                if (
                  p ||
                  window.__captchah5__umidToken.indexOf("defaultToken")
                ) {
                  clearInterval(_),
                  ...
                  var o = {
                    ...
                    r = function (t, i) {
                      var o =
                          "ok" === t && i && i.success && 0 === i.result.code,
                    ...
                    s = g.timeout || 1e4;
                  g.replaceCallback
                    ? g.replaceCallback(v.analyze, o, r, s)
                    : t(v.analyze, o, r, s);
                } else f++ > 100 && clearInterval(_);
              }
              var c = g.trans || {};
              ...
              try {
                c.ncSessionID = d(
                  document
                    .getElementById(n.prefix + "-stage-1")
        ...
        function (e, n, t) {
          ...
          n.makeSlider = function (e) {
            ...
            function u(e, t) {
              var i = n(".track div");
              (i.innerHTML = e), (i.className = "bg-" + (t || "green"));
            }
            function f(e) {
              var t = n(".slider .icon");
              t.className = "icon " + e;
          ...
          n.init = function (e, n) {
            (e.onreset = function () {}),
              (e.onbeforereset = function () {
                n._reset(), n.ui.init(), n.slider.enable();
              }),
        ...
        function (e, n, t) {
          ...
          n.init = function (e, n) {
            ...
            (e.onenterloading = function () {
              ...
              var s = !0;
              if (
                (o.load(n, function (e, t) {
                  (s = !1),
                    e
                      ? (n.fsm.loaderror(t), n.net.netErrorReport(t))
                      : n.fsm.load();
                }),
                s)
              ) {
        ...
        function (e, n, t) {
          ...
          n.init = function (e, n) {
            e.onenterneed_two_step_verify = function (t, i, o, r) {
              n.fire("beforeverify"), e.showtwostep(r);
            };
          };
        },
        function (e, n, t) {
        ...
        function (e, n, t) {
          ...
          n.init = function (e, n) {
            ...
            e.onenterready = function () {
              var e = i(".label"),
                o =
                  "https://img.alicdn.com/tfs/TB1GhJXQXXXXXa.XFXXXXXXXXXX-75-52.png";
              n.options.isClick
                ? (e.innerHTML = "")
                : (e.innerHTML = t("SLIDER_LABEL"));
        ...
        function (e, n, t) {
          ...
          n.init = function (e, n) {
            e.onenterts_error = function () {
              i.hide(n.prefix), e.ts_verifyerror2();
            };
          };
        },
        function (e, n, t) {
            ...
            function c() {
              ...
              function c(t) {
                ...
                o.jsonp(
                  ...
                  function (n, i) {
                    var o =
                      "ok" === n && i && i.success && 0 === i.result.resultCode;
                    o
                      ? t(i)
                      : "timeout" === n &&
                        e.can("verifyerror") &&
              ...
              function f(t) {
                return (
                  "ts_verifying" !== e.current &&
                  (t && n.fire("beforeverify"),
                  void c(function (e) {
                    (s = e),
                      (_ = s.result.data[0]),
            ...
            (u = o.mix(u, l.apimap)),
              (e.onenterts_loading = function (i, o, r, a) {
                n.slider.setTitle(t("CHECK_N"), "red"),
                  ...
                  setTimeout(function () {
                    n.ui.setActiveStage(2), c(), e.ts_load();
                  }, 500);
              });
          };
        },
        function (e, n, t) {
          ...
          n.init = function (e, n) {
            (e.onenterts_pass = function (n, t, i, o) {
              (o.sig = o.sig || o.value), e.ts_passed(o);
            }),
              (e.onleavets_pass = function () {
                i.hide(n.prefix), n.ui.setActiveStage(1);
              });
          };
        },
        function (e, n, t) {
              ...
              function e() {
                n.net.postSlide(function (e, t) {
                  return (
                    i != -1 && clearTimeout(i),
                    "timeout" === e.state
                      ? void (n.fsm.can("verifyerror") && n.fsm.verifyerror(t))
                      : (e.pass
                          ? n.fsm.can("verifypass") && n.fsm.verifypass(t)
                          : 300 == t.code
                          ? n.fsm.can("verifyfail") && n.fsm.verifyfail(t)
                          : n.fsm.can("verifytwostep") &&
                            n.fsm.verifytwostep(t),
                        void (
                          n.options.isClick && n.slider.setIcon("nc-hidden")
                        ))
                  );
                });
              }
          ...
          n.makeUI = function (e) {
            ...
            function u(n) {
              ...
              if (
                ...
                var o = document
                  .getElementById(e.prefix + "-stage-3")
            ...
            function p() {
              ...
              if (
                ((o.onclick = function () {
                  "load_error" == e.getState()
                    ? (e.fsm.continueloading(), e.slider.enable())
                    : e.has("refresh")
                    ? e.fire("refresh")
                    : NoCaptcha.reset();
                }),
            ...
            return (
              ...
              (_.init = function () {
                o.hide(e.prefix),
                  ...
                  e.options.isClick &&
                    ((e.click2slider = c.makeClickSlider(e)),
        ...
        function (e, n, t) {
          ...
          !(function () {
            ...
            if (!e.__nch5) {
              ...
              var n = t(70).makeNC,
                i = n();
              (i.v = t(5).v), (e.__nch5 = i), (e.NoCaptcha = i);
            }
          })();
        },
        ,
